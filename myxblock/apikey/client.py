...
class Client():
    ...
    def mass_properties(self, did, wid, eid, partid):
        return self._api.request('get', '/api/parts/d/' + did + '/w/' + wid + '/e/' + eid + '/partid/' + partid + '/massproperties')

    def parts_in_partstudio(self, did, wid, eid):
        return self._api.request('get', '/api/parts/d/' + did + '/w/' + wid + '/e/' + eid)
